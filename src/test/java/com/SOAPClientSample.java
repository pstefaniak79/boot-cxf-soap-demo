...
public class SOAPClientSample {
   ...
   <rpn:LookupRPNRequest xmlns:rpn="http://www.ros.ie/schemas/paye-employers/v1/rpn/">
...

    {
        ...
        File requestFile = new File("d:\\1\\LOOKUP-RPN1.xml");
    ...
    private java.security.cert.Certificate getCertificate() throws Exception {
        ...
        keystore.load(new FileInputStream(new File("d:/1/keystore.jks")), password.toCharArray());

        // (v) Extract the certificate.
        java.security.cert.Certificate cert = keystore.getCertificate("soap");
    ...
    private PrivateKey getKeyFormCert() throws Exception {
        ...
        PrivateKey key = (PrivateKey) keystore.getKey("soap", password.toCharArray());
 ...
 <env:Envelope xmlns:env="http://www.w3.org/2003/05/soap-envelope">
			...
			<ds:Signature xmlns:ds="http://www.w3.org/2000/09/xmldsig#">
				<ds:SignedInfo>
					...
					<ds:Reference URI="#Body">
						...
						<ds:DigestValue>+I/W7eTNgtLlOtxazFh+vjAG+MCUET2+LJ2yu3+iP4A6yJznTkdQiJ34onWE8SYAoZUYD2MKvsHtWz++X9wzEA==</ds:DigestValue>
					</ds:Reference>
					<ds:Reference URI="#TS">
						<ds:Transforms>
							<ds:Transform Algorithm="http://www.w3.org/2001/10/xml-exc-c14n#"/>
						...
						<ds:DigestMethod Algorithm="http://www.w3.org/2001/04/xmlenc#sha512"/>
						<ds:DigestValue>Jr/9zWaQ0Y7VBQE9OM6HPwzX+AD7tNnAiJFYqRdF0E+b40c9JZt/f4w0x25v9kKMszAovhgmbEQc1ZrVzG5d2Q==</ds:DigestValue>
					</ds:Reference>
				</ds:SignedInfo>

				<ds:SignatureValue>GPBxhqQ6aBcIQDpphqboZsTJYjbM6FJcnpDckUjNymp4MZZpPpasn1eo0CWKOM3GxqKh1BiNt586YIPrDne6gkyYtadRiLMKQKFwWpQDvjGTtjfLfi5EHzTyD2OhAH+VswOvsNraLlDC8Ph4qc6rpCu2HwiRW/vl+8a2v3pyL/c=</ds:SignatureValue>
    ...
    private void outputSOAPMessageToFile(SOAPMessage soapMessage)
        ...
        File outputFile = new File("D:\\1\\output.soap");
    ...
    private void callTheWebServiceFromFile() throws IOException, SOAPException {
        ...
        File soapFile = new File("D:\\1\\output.soap");
